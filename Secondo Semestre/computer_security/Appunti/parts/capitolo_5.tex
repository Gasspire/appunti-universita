...
\begin{itemize}
    ...
    \item \textbf{used}: L'operatore used comprende tutto ciò che è stato detto tramite l'operatore says e notes. 
...
\begin{itemize}
    ...
    \item \textbf{Fake}: Modella l'intruso. Se \texttt{evsf} è una traccia valida, lo \textit{Spy} può inviare a chiunque un messaggio \texttt{X} generato tramite \texttt{synth(analz(knows Spy evsf))}.
